angular.module("myFriendsApp").controller("FriendController", function($scope) {
console.log($scope.sortDirection);
  ...
  // <option value="friend_count"></option>
  // <option value="current_location.city"></option>
  // <option value="current_location.state"></option>
  // <option value="current_location.country"></option>
  $scope.sortOptions = ["Name", "#Friends", "City", "State", "Country"];
